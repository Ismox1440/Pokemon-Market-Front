    ...
    <Link to={`/pokemon/${pokemon?._id}`} className={classNames}>
      <div className='w-[252px] h-[308px] bg-[#3A4254] flex flex-col rounded-lg border-gray-700 transition-all duration-100 hover:border-[#31363f]  overflow-hidden'>
        ...
        >
          ...
          <div className='absolute scale-90 rounded top-[10px]  items-center rounde inline-flex justify-center py-[4px] px-[8px] whitespace-nowrap'>
          ...
          <div className='mt-[40px] '>
            {images?.default ? (
              ...
              <h3 className='text-white text-opacity-60 text-center text-8xl font-extrabold font-mono'>
                ?
              </h3>
            )}
          </div>
          {pokemon.onSale && pokemon.price && (
            <h3 className='text-gray-200 flex gap-2 items-center justify-center mt-2'>
