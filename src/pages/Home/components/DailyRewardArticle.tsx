...
const DailyRewardArticle = () => {
  return (
    ...
    <article
      ...
      className='w-full relative z-10 border-2 hover:border-gray-200 cursor-pointer border-gray-700 flex items-center justify-center flex-col rounded-2xl h-full bg-gradient-to-b from-[#FDD89A] to-[#8A645F]'
    >
      <img
      ...
      />
      <h3 className='text-gray-200 tracking-wider relative z-10 uppercase text-2xl text-center mt-2 font-extrabold'>
        Daily Rewards
      </h3>
